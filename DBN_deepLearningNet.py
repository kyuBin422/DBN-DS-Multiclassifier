...
def load_data(dataset):
    ...
    X = numpy.load("achieve/ProcessedData.npy")
    label = numpy.load("achieve/label.npy")

    train_set_x, test_set_x, train_set_y, test_set_y = train_test_split(X, label, test_size=0.33, random_state=42)
...
def test_DBN(finetune_lr=0.1, pretraining_epochs=10,
    ...
    dbn = DBN(numpy_rng=numpy_rng, n_ins=train_set_x.shape.eval()[1],
              hidden_layers_sizes=[1000, 1000, 1000, 1000],
              n_outs=numpy.unique(train_set_y.eval()).size)
